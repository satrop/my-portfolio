...
// node_modules/react-scrollspy-navigation/dist/ScrollSpy.js
var require_ScrollSpy = __commonJS({
  "node_modules/react-scrollspy-navigation/dist/ScrollSpy.js"(exports) {
    "use strict";
    ...
    var ScrollSpy = function ScrollSpy2(_ref) {
      var _ref$className = _ref.className, className = _ref$className === void 0 ? "active" : _ref$className, _ref$offsetTop = _ref.offsetTop, offsetTop = _ref$offsetTop === void 0 ? 0 : _ref$offsetTop, _ref$offsetLeft = _ref.offsetLeft, offsetLeft = _ref$offsetLeft === void 0 ? 0 : _ref$offsetLeft, _ref$duration = _ref.duration, duration = _ref$duration === void 0 ? 1e3 : _ref$duration, children = _ref.children;
      (0, _react.useEffect)(function() {
        var sourceElements = [];
        var targetElements = [];
        var pendingScroll;
        var throttle = function throttle2(fn) {
          var wait = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 100;
          var timer;
          var time = Date.now();
        ...
        var onClickHandler = function onClickHandler2(event, targetTop, targetLeft, targetDuration) {
          ...
          var step = {
            x: Math.round(diff.x / Math.abs(targetDuration) * 1e3 / 16),
            y: Math.round(diff.y / Math.abs(targetDuration) * 1e3 / 16)
          };
          var tick = function tick2(scrollTop) {
            var scrollLeft = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
            var diffTick = {
              x: Math.round(scrollToPosition.x - scrollElement.scrollLeft),
              y: Math.round(scrollToPosition.y - scrollElement.scrollTop)
            };
            ...
            return requestAnimationFrame(function() {
              return tick2(scrollTop, scrollLeft);
            });
          };
...
// node_modules/react-scrollspy-navigation/dist/index.js
var require_dist = __commonJS({
  "node_modules/react-scrollspy-navigation/dist/index.js"(exports, module) {
    module.exports = require_ScrollSpy();
  }
});
export default require_dist();
//# sourceMappingURL=react-scrollspy-navigation.js.map
