...
var collapseWarning = (...args) => {
  return tiny_warning_esm_default(args[0], `[react-collapsed] -- ${args[1]}`);
};
...
function useControlledState(value, defaultValue, callback) {
  const [state, setState] = (0, import_react4.useState)(defaultValue);
  const initiallyControlled = (0, import_react4.useRef)(typeof value !== "undefined");
...
function usePrefersReducedMotion() {
  const [prefersReducedMotion, setPrefersReducedMotion] = (0, import_react5.useState)(false);
...
function useCollapse({
  ...
  const prevExpanded = (0, import_react.useRef)(isExpanded);
  ...
  const frameId = (0, import_react.useRef)();
  const endFrameId = (0, import_react.useRef)();
  const collapseElRef = (0, import_react.useRef)(null);
  const [toggleEl, setToggleEl] = (0, import_react.useState)(null);
  ...
  return {
    ...
    getToggleProps(rest) {
      ...
      const theirRef = rest == null ? void 0 : rest[refKey || "ref"];
      const props = {
